...
var GameBoard = function() {
  ...
  // La lista actual de objetos
  this.objects = [];
  this.cnt = {};

  // Agregar un nuevo objeto a la lista de objetos
  ...
  // Restablecer la lista de objetos eliminados
  this.resetRemoved = function() { this.removed = []; };

// Marcar un objeto para eliminarlo
  ...
  // Se eliminó un objeto marcado para su eliminación de la lista.
  ...
  //Llame al mismo método en todos los objetos actuales
...
// Encuentra el primer objeto para el que func es verdadero
 ...
 // Llamar al paso a todos los objetos y eliminarlos
// Cualquier objeto que haya sido marcado para su eliminación
  this.step = function(dt) { 
    this.resetRemoved();
